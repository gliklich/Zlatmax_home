    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                fromValue.addEventListener("change", (function(values, handle) {
                    item.noUiSlider.set([ fromValue.value, null ]);
                }));
                toValue.addEventListener("change", (function(values, handle) {
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        const allSlidersItems = document.querySelectorAll(".slide-main-block:not(.swiper-slide-duplicate)");
                        allSliders.innerHTML = allSlidersItems.length < 10 ? `0${allSlidersItems.length}` : allSlidersItems.length;
                    },
                    slideChange: function(swiper) {
                        const currentSlider = document.querySelector(".fraction-controll__current");
                        currentSlider.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : swiper.realIndex + 1;
                    }
                }
            });
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("Ой, ой, нет такого под меню");
                e.preventDefault();
            }
